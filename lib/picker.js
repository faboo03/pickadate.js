...
function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
    ...
    var
        ...
        SETTINGS = COMPONENT ? $.extend( true, {}, COMPONENT.defaults, { eventCatcherSelector: document }, OPTIONS ) : OPTIONS || {},
        ...
        P = PickerInstance.prototype = {
            ...
            open: function( dontGiveFocus ) {
                ...
                if ( dontGiveFocus !== false ) {
                    ...
                    $(SETTINGS.eventCatcherSelector).on( 'click.P' + STATE.id + ' focusin.P' + STATE.id, function( event ) {
            ...
            close: function( giveFocus ) {
                ...
                if ( STATE.open ) {
                    ...
                    $(SETTINGS.eventCatcherSelector).off( '.P' + STATE.id )
                }
